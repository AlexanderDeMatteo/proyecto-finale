        ...
        <nav className="nav flex-column" id="box2">
            ...
            <li className="nav-item dropdown" id="hola">
                ...
                <ul className="dropdown-menu"> : ""
                    {store.userData.is_psicologo ? <li><a className="dropdown-item" href="#">Expedientes</a></li> : ""}
                    {store.userData.is_psicologo ? <li><a className="dropdown-item" href="#">Manejo de agenda</a></li> : ""}
                </ul>
            </li>
            <li className="nav-item dropdown" id="hola">
            ...
            {store.userData.is_psicologo ? <a className="/buscador" href="#">Buscador de colegas</a> : <a className="nav-link" href="/buscador">Buscador de psicologos</a>}
